                        ...
                        <div class="trending-top mb-30">
                            <div class="trend-top-img">
                                ...
                                <div class="trend-top-cap">
                                    ...
                                    <a href="details.html"><h2>Welcome To The Best Model Winner<br> Contest At Look of the year</h2></a>
                                </div>
                            </div>
                        </div>
                        <!-- Trending Bottom -->
    ...
    <x-slot name="js">
        <script>
            // $(document).ready(() => {
                ...
                // TOP
                $.get("{{ route('datas.post.top') }}", (tops) => {
                    let bottom = `<div class="row">`;
                    let side = "";
                    tops.forEach((top, index) => {
                        if(index == 0) {
                            let el = $('.trending-top');
                            el.find('img').attr('src', top.image)
                            el.find('span').text((top.category == null) ? "" : top.category.name)
                            el.find('h2').text(top.title).addClass('text-white')
                            el.find('a').attr('href', '/'+top.url)
                            ...
                            bottom += `<div class="col-lg-4">
                                            <div class="single-bottom mb-35">
                                                ...
                                                <div class="trend-bottom-cap">
                                                    <span class="color1">${(top.category == null) ? "" : top.category.name}</span>
                                                    <h4><a href="${'/'+top.url}">${top.title}</a></h4>
                                                </div>
                                            </div>
                                        </div>`
                        } else {
                            side += `<div class="trand-right-single d-flex">
                                        <div class="trand-right-img">
                                            <img src="${top.thumbnail}" style="max-width:120px" alt="">
                                        </div>
                                        <div class="trand-right-cap">
                                            <span class="color1">${(top.category == null) ? "" : top.category.name}</span>
                                            <h4><a href="${'/'+top.url}">${top.title}</a></h4>
                ...
                function post_category(id='all') {
                    $.get("/datas/by-category/"+id, (posts) => {
                        let posting = ``;
                        posts.data.forEach(post => {
                            posting += `<div class="col-lg-6 col-md-6">
                                            <div class="single-what-news mb-100">
                                                ...
                                                <div class="what-cap">
                                                    <span class="color1">${(post.category == null)? "" : post.category.name}</span>
